...
program
  ...
  .option("--keep-source", "Indicate that messages in the queue should be kept", true)
  .option(
    "--endpoint-url <string>",
...
program
  ...
  .option("--keep-source", "Indicate that messages in the source queue should be kept", true)
  .option(
    "--endpoint-url <string>",
    "Just like in aws-cli commands, this is only required when using a local version of SQS and Lambda (e.g. LocalStack)"
  )
